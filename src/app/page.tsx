          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                ...
                <img src='/snake-1.png' className='w-full' alt="case-cobra" />
              </div>
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                CaseCobra allows you to protect your memories, not jut your phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" alt="user image" src='/users/user-1.png' />
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" alt="user image" src='/users/user-2.png' />
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" alt="user image" src='/users/user-3.png' />
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" alt="user image" src='/users/user-4.jpg' />
                  <img className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-slate-100" alt="user image" src='/users/user-5.jpg' />
                </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                &quot;The case feels durable and I even got a compliment on teh design. Had the case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it.&quot;
                </p>
              </div>

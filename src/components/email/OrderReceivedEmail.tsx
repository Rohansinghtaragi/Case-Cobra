...
import { Body, Column, Container, Head, Heading, Hr, Html, Text, Img, Preview, Row, Section } from '@react-email/components'
...
const OrderReceivedEmail = ({shippingAddress, orderId, orderDate}: {shippingAddress: ShippingAddress, orderId: string, orderDate: string}) => {
    ...
    const baseUrl = process.env.NODE_ENV === 'development'? 'http://localhost:3000' : 'https://case-cobra-app-nine.vercel.app/'
  return (
    <Html>
      <Head />
        ...
        <Container style={container}>
          ...
          <Section style={message}>
            <Img src={`${baseUrl}/snake-3.png`} width='65' height='73'
              alt='delivery snake' style={{ margin: 'auto' }}
            />
